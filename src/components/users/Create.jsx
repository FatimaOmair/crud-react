...
if(loader){
  ...
  return (
    ...
    <div className="row flex-nowrap">
      ...
      <Input errors={errors} id={'username'} title={'user name'}  type={'text'} name={'name'} customClasses="border-warning-subtle shadow-none" handleData={handleData}/>
      <Input errors={errors} id={'email'} title={'user email'} type={'email'} name={'email'} customClasses="border-warning-subtle shadow-none" handleData={handleData}/>

      <Input errors={errors} id={'password'}  title={'user password'} type={'password'} name={'password'} customClasses="border-warning-subtle shadow-none" handleData={handleData}/>

      <div className='mb-3'>
 <input type="submit" className="form-control bg-danger-subtle" value='Add User'/>
 </div>
</form>
