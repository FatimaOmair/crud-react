...
export default function Edit() {
    ...
    const [errorBack, setErrorbak] = useState("");
   ...
   const sendData= async(e)=>{
    ...
    }else
    {
     try{
      ...
      setErrorbak(error.response.data.message);
      setErrors([]);
      setLoader(false)
     }}
  ...
  <div className="row flex-nowrap">
    ...
    <form onSubmit={sendData}>
      ...
      <Input errors={errors} id={'username'} title={'user name'}  type={'text'} name={'name'} customClasses="border-warning-subtle shadow-none" changeData={changeData}/>
      <Input errors={errors} id={'email'} title={'user email'} type={'email'} name={'email'} customClasses="border-warning-subtle shadow-none" changeData={changeData}/>
      <Input errors={errors} id={'password'} title={'user password'}  type={'password'} name={'password'} customClasses="border-warning-subtle shadow-none" changeData={changeData}/> 

     
 <div className='mb-3'>
 <input type="submit" className="form-control bg-danger-subtle" value='Update the user'/>
 </div>
